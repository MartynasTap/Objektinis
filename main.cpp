...
int main()
{
    ...
    if (k==1){
        ...
        if(d==0){
            ...
            cout << "Duomenu nuskaitymas is 1000 irasu failo uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            sort(grupe.begin(),grupe.end(),compareElement);
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "1000 irasu rusiavimas pagal varda uztruko: "<< diff.count() << " s\n";
            for(auto &a: grupe){galutinis_vid(a);galutinis_med(a);}
            start = std::chrono::high_resolution_clock::now();
            rusiavimas(grupe,vargsiukai,kietekai);
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "1000 irasu dalijimas i dvi grupes uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            isvedimas_i_faila(vargsiukai,"rez_stud1000_vargsiukai.txt");
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "1000 irasu vargsiukai irasymas i faila uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            isvedimas_i_faila(kietekai,"rez_stud1000_kietekai.txt");
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "1000 irasu kietekai irasymas i faila uztruko: "<< diff.count() << " s\n";
            cout << endl;
            std::chrono::duration<double> diff_viso = std::chrono::high_resolution_clock::now()-start_viso;
            cout << "1000 irasu testo visa trukme: "<< diff_viso.count() << " s\n";
            cout << endl;
            ...
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "Duomenu nuskaitymas is 10000 eiluciu failo uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            sort(grupe.begin(),grupe.end(),compareElement);
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "10000 irasu rusiavimas pagal varda uztruko: "<< diff.count() << " s\n";
            for(auto &a: grupe){galutinis_vid(a);galutinis_med(a);}
            start = std::chrono::high_resolution_clock::now();
            rusiavimas(grupe,vargsiukai,kietekai);
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "10000 eiluciu dalijimas i dvi grupes uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            isvedimas_i_faila(vargsiukai,"rez_stud10000_vargsiukai.txt");
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "10000 irasu vargsiukai irasymas i faila uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            isvedimas_i_faila(kietekai,"rez_stud10000_kietekai.txt");
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "10000 irasu kietekai irasymas i faila uztruko: "<< diff.count() << " s\n";
            cout << endl;
            diff_viso = std::chrono::high_resolution_clock::now()-start_viso;
            cout << "10000 irasu testo visa trukme "<< diff_viso.count() << " s\n";
            cout << endl;
            ...
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "Duomenu nuskaitymas is 100000 eiluciu failo uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            sort(grupe.begin(),grupe.end(),compareElement);
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "100000 irasu rusiavimas pagal varda uztruko: "<< diff.count() << " s\n";
            for(auto &a: grupe){galutinis_vid(a);galutinis_med(a);}
            start = std::chrono::high_resolution_clock::now();
            rusiavimas(grupe,vargsiukai,kietekai);
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "100000 eiluciu dalijimas i dvi grupes uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            isvedimas_i_faila(vargsiukai,"rez_stud100000_vargsiukai.txt");
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "100000 irasu vargsiukai irasymas i faila uztruko: "<< diff.count() << " s\n";
            start = std::chrono::high_resolution_clock::now();
            isvedimas_i_faila(kietekai,"rez_stud100000_kietekai.txt");
            diff = std::chrono::high_resolution_clock::now()-start;
            cout << "100000 irasu kietekai irasymas i faila uztruko: "<< diff.count() << " s\n";
            cout << endl;
            diff_viso = std::chrono::high_resolution_clock::now()-start_viso;
            ...
            isvedimas_i_faila(vargsiukai,"rez_stud10000000_kietekai.txt");*/
        }
    }
    return 0;
}
